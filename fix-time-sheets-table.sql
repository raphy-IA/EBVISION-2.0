-- Script pour corriger la table time_sheets
...
CREATE INDEX idx_time_sheets_semaine ON time_sheets(annee, semaine);
CREATE INDEX idx_time_sheets_dates ON time_sheets(date_debut_semaine, date_fin_semaine);
...
COMMENT ON COLUMN time_sheets.total_heures IS 'Total des heures de la semaine';
COMMENT ON COLUMN time_sheets.total_heures_chargeables IS 'Total des heures chargeables';
COMMENT ON COLUMN time_sheets.total_heures_non_chargeables IS 'Total des heures non chargeables';
