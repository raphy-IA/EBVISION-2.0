-- Migration 019: Création de la table opportunities (version simplifiée - OBSOLÈTE)
-- Date: 2025-07-20
...
DO $$
BEGIN
    RAISE NOTICE 'Migration 019_create_opportunities_table_simple.sql ignorée (version obsolète, remplacée par 019_create_opportunities_table.sql).';
END$$;
