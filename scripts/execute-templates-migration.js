...
async function executeTemplatesMigration() {
    try {
        console.log('🔄 Exécution de la migration des templates d\'étapes...');
        ...
        console.log('✅ Templates d\'étapes créés');
        ...
        console.log('🎉 Migration des templates terminée avec succès !');
        
    } catch (error) {
        console.error('❌ Erreur lors de la migration des templates:', error);
    } finally {
        await pool.end();
    }
}
