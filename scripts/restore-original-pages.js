...
// Fonction pour restaurer une page
function restorePage(pageName) {
    ...
    try {
        ...
        // Si c'est une page avec du contenu spécifique, la restaurer
        if (pageName === 'opportunity-types.html' || 
            pageName === 'opportunity-stages.html' || 
            pageName === 'opportunity-details.html' ||
            pageName === 'login.html' ||
            pageName === 'logout.html') {
            // Ces pages ont du contenu spécifique, on les garde mais on corrige les styles
            content = fixPageStyles(content);
            fs.writeFileSync(pagePath, content);
            console.log(`✅ Page ${pageName} restaurée avec contenu spécifique`);
        } else {
            // Pour les autres pages, on utilise le template unifié mais on garde le contenu spécifique
            console.log(`⚠️ Page ${pageName} - Contenu spécifique à vérifier manuellement`);
        }
...
function restoreAllPages() {
    console.log('🔧 Restauration des pages originales...');
    ...
    const pages = [
        ...
        'login.html',
        'logout.html',
        'collaborateurs.html' // Déjà restauré depuis la sauvegarde
    ];
    ...
    console.log('📝 Note: Les autres pages ont été remplacées par des templates génériques.');
    console.log('🔍 Vérifiez manuellement les pages qui ont du contenu spécifique.');
}
...
module.exports = { restoreAllPages, restorePage, fixPageStyles }; 