...
/**
 * Script d'export de la structure de base de données LOCALE
 * Exporte la structure de la base de données de développement
 */
...
// Configuration de la base de données LOCALE (développement)
const LOCAL_CONFIG = {
...
module.exports = { DatabaseExporter, exportLocal };
