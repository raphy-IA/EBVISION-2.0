...
async function runMigration019Simple() {
    try {
        console.log('🚀 Exécution de la migration 019 (version simplifiée): Création de la table opportunities...\n');
        
        // Lire le fichier de migration
        const migrationPath = path.join(__dirname, '..', 'database', 'migrations', '019_create_opportunities_table_simple.sql');
