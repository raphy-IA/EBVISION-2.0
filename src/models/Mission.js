...
class Mission {
    constructor(data) {
        ...
        this.mission_type_id = data.mission_type_id;
        this.date_debut = data.date_debut;
        this.date_fin_prevue = data.date_fin_prevue;
        this.date_fin_reelle = data.date_fin_reelle;
        this.budget_prevue = data.budget_estime || data.budget_prevue; // Map budget_estime (DB) to budget_prevue (App)
        this.budget_estime = data.budget_estime; // keep original too
